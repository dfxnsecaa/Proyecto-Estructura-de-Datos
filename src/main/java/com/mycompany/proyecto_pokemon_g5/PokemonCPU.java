...
public class PokemonCPU {
    ...
    // Constructor
    public PokemonCPU(int indice, int tipo, String nombreP, int vida, int ataque, int defensa, int ataqueEspecial, int defensaEspecial) 
    {
        this.indice = indice;
        this.tipo = tipo;
    ...
    public void ataqueFisico(PokemonCPU oponente) 
    {
    ...
    public void ataqueEspecial(PokemonCPU oponente) 
    {
